...
Go to [learn.microsoft.com](https://learn.microsoft.com/) and sign in with a personal Microsoft account. Use your personal email so you keep the account after the course.

The course materials live at: [learn.microsoft.com/en-us/training/courses/ai-900t00](https://learn.microsoft.com/en-us/training/courses/ai-900t00)

There are 5 learning paths in total. You'll complete them across the quarter.

### Azure Account

You'll also want to set up a free student Azure account at [azure.microsoft.com/en-us/free/students](https://azure.microsoft.com/en-us/free/students). Use your GRC student email for this. It should not ask for a credit card. If it does, you've ended up in the wrong subscription type. The student account gives you free access to Azure services and $100 in credits, which you'll use for labs throughout the course.

## How to Do the Assignments

Each assignment covers a portion of the AI-900 learning paths.

- Complete all modules in the assigned learning paths
- Do every quiz and knowledge check. These mirror what you'll see on the exam
- Try the labs in Azure when they're available. Hands-on experience with the platform helps, and we won't have time to cover everything in class
- Use Google, YouTube, or AI tools to get clarification on anything confusing. Just be aware that AI tools sometimes struggle with platform-specific details, so verify anything important against the official docs
